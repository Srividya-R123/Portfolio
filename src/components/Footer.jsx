...
const Footer = () => {
  return (
   ...
   <a href="mailto:pdamit22@gmail.com"><img src={mail} className="h-[50px] w-[50px] rounded-full float-left mr-3 border-2 border-solid border-slate-950"/><p className='mt-2 hover:text-rose-900'>pdamit22@gmail.com</p></a></p></div>
        ...
        <h3 className='ml-[110px] text-[20px] text-bold'>Join Us Now!</h3><br/><a href="/login" class="h-30 w-80 relative inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500">
<span class="absolute inset-0 w-full h-full bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-700"></span>
<span class="absolute bottom-0 right-0 block w-64 h-64 mb-32 mr-4 transition duration-500 origin-bottom-left transform rotate-45 translate-x-24 bg-pink-500 rounded-full opacity-30 group-hover:rotate-90 ease"></span>
<span class="relative text-white">Sign Up</span>
</a><h3 className='ml-[100px] mt-[30px]'>Connect With Us</h3><br/><div className='ml-[80px]'>
